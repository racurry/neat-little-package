...
Reviews and validates Claude Code components against official specs and loaded skills. Read-only — provides analysis and recommendations, never modifies files.
...
3. **Validate** against official specs and loaded skills' gotchas and preferences. For skills specifically, validate against the agent-skills skill's principles (self-containment, knowledge delta, portability)
