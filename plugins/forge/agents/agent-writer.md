...
1. **Load design skills (REQUIRED)** - Use Skill tool to load both skills BEFORE proceeding
   ...
   **WHY both skills:**
   - `forge-architecture` - Understanding agent isolation, delegation chains, component interaction
...
4. **Design the agent** following agent-design skill principles:
   ...
   **Skill tool (ALMOST ALWAYS REQUIRED):**
   ...
   - ✓ Forge agents should load architecture/design skills for guidance
...
8. **Validate Forge compliance (REQUIRED)** - Before completing, verify the agent follows ALL Forge principles:
