...
**Most common Forge pattern:** Commands are thin wrappers that delegate to specialized agents.
...
### Example 3: Forge Meta-Ecosystem (Self-Documenting)
...
├── hooks-design
├── plugin-design
└── forge-architecture (this skill!)
```

**Why this is powerful:**

- Forge uses its own patterns to create itself
